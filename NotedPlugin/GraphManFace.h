...
public:
	...
	GraphMetadata() {}
	GraphMetadata(lb::SimpleKey _operationKey, Axes const& _axes = { { "", lb::XOf(), lb::Range(0,1) } }, std::string const& _title = "Anonymous", bool _rawSource = false): m_rawSource(_rawSource), m_operationKey(_operationKey), m_title(_title), m_axes(_axes) {}
