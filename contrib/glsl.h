...
namespace cwc
{
   ...
   */
   ...
   public:
	  ...
	  char const* getCompilerLog(void);                     //!< get compiler messages
...
//-----------------------------------------------------------------------------
   ...
   public:
	  ...
	  char const*getLinkerLog(void);                //!< Get Linker Messages \return char pointer to linker messages. Memory of this string is available until you link again or destroy this class.
